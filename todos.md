...
- [] improve on the hero section 
- [] could allow a user to have a filter section to allow which category to view selected literary category
- [] featured stories to be updated to also follow a grid of three layout
- [] latest articles 
- [] have a small reviews section that has three small overlapping avatars of different users 
...
- [] fix the book logo to something else
- [] remove the hover effect on logo
